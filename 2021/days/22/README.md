...
The final step ( `on x=10..10,y=10..10,z=10..10` ) turns _on_ a single cube, `10,10,10` . After this last step, `39` cubes are _on_ .
...
The last two steps are fully outside the initialization procedure area; all other steps are fully within it. After executing these steps in the initialization procedure region, `590784` cubes are _on_ .
